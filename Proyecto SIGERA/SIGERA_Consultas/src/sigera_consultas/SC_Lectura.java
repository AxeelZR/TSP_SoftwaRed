...
public class SC_Lectura {
    ...
    public void RecibirMensaje(String NomCola) throws IOException, TimeoutException {
        try {
            ...
            channel.queueDeclare("juan", false, false, false, null);
            ...
            channel.basicConsume("juan", true, consumer);
